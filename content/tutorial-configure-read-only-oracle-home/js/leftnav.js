...
function amIPartofALearningPath() {
    ...
    $.getJSON(url).done(function(data) {
        ...
        if (data.items.length > 0) {
            ...
            content += "This tutorial is associated with learning paths. Click a link to view the tutorial in the context of that learning path.<br/>";
            ...
            content += '</ul>';
			content += '</div>';
            content += "<p>Or view it outside a learning path:</p>";
            content += '</div>'
