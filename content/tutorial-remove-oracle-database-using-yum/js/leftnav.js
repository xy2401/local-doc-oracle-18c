...
function amIPartofALearningPath() {
    ...
    $.getJSON(url).done(function(data) {
        ...
        if (data.items.length > 0) {
            ...
            content += "This OBE is associated with the following learning paths. Select a learning path to view the OBE within that learning path or close this dialog box to continue outside of a learning path.<br/>";
