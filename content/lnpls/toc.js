    ...
    "toc":[
        {
            ...
            "topics":[
                ...
                },
                {
                    ...
                    "topics":[
                        {
                            "title":"Non-Persistance Support for Object Types",
                            "href":"release-changes.html#GUID-23D5267B-36BB-4182-BD17-CEB4BC345006"
                        },
                        {
                            "title":"Polymorphic Table Functions",
                            "href":"release-changes.html#GUID-5F0A1EE8-E36C-4418-9E77-E1A41BCAB57F"
                        },
                        {
                            "title":"Qualified Expressions",
                            "href":"release-changes.html#GUID-0DAD7856-4AB9-4DBF-AD48-DD24B454E74D"
                        },
                        {
                    ...
                    "topics":[
                        {
                            ...
                            "topics":[
                                ...
                                {
                                    "title":"<span class=\"secnum\">2.1.3 </span> About Data-Bound Collation",
                                    "href":"plsql-language-fundamentals.html#GUID-393E49ED-5C87-4C82-B1B9-003A8230240C"
                                }
                            ]
                        },
                        {
                ...
                },
                {
                    ...
                    "topics":[
                        ...
                        {
                            "title":"<span class=\"secnum\">5.13 </span> Assigning Values to Record Variables",
                            "href":"plsql-collections-and-records.html#GUID-794AD0D6-2D97-4C4A-B7DA-6126025EF2A5",
                            "topics":[
                                {
                                    "title":"<span class=\"secnum\">5.13.1 </span> Assigning One Record Variable to Another",
                                    "href":"plsql-collections-and-records.html#GUID-E6D99438-0B7F-4468-B9AD-97CFC47BDD73"
                                },
                                {
                                    "title":"<span class=\"secnum\">5.13.2 </span> Assigning Full or Partial Rows to Record Variables",
                                    "href":"plsql-collections-and-records.html#GUID-59D7C4DF-4CE0-4E82-81FA-CBE17282E1EF",
                                    "topics":[
                                        {
                                            "title":"<span class=\"secnum\">5.13.2.1 </span> Using SELECT INTO to Assign a Row to a Record Variable",
                                            "href":"plsql-collections-and-records.html#GUID-785E5E7E-7FCD-4291-8F62-389814A261EC"
                                        },
                                        {
                                            "title":"<span class=\"secnum\">5.13.2.2 </span> Using FETCH to Assign a Row to a Record Variable",
                                            "href":"plsql-collections-and-records.html#GUID-CC1DA893-4087-4DA4-8B13-052AB76DAC4F"
                                        },
                                        {
                                            "title":"<span class=\"secnum\">5.13.2.3 </span> Using SQL Statements to Return Rows in PL/SQL Record Variables",
                                            "href":"plsql-collections-and-records.html#GUID-95EA1F91-8196-4F77-8EA3-36CAD9B43855"
                                        }
                                    ]
                                },
                                {
                                    "title":"<span class=\"secnum\">5.13.3 </span> Assigning NULL to a Record Variable",
                                    "href":"plsql-collections-and-records.html#GUID-6AB78084-231F-4BCA-A905-DB2069E4B885"
                                }
                            ]
                        },
                        {
                            "title":"<span class=\"secnum\">5.14 </span> Record Comparisons",
                            "href":"plsql-collections-and-records.html#GUID-DFDE40BD-4B61-4C8A-B9CE-3FE01E21F658"
                        },
                        {
                            "title":"<span class=\"secnum\">5.15 </span> Inserting Records into Tables",
                            "href":"plsql-collections-and-records.html#GUID-AC5CEFCB-87AA-41FD-AE16-FFE66606E6B1"
                        },
                        {
                            "title":"<span class=\"secnum\">5.16 </span> Updating Rows with Records",
                            "href":"plsql-collections-and-records.html#GUID-11D63245-591D-4CBF-BFBA-8F3C0AE0E968"
                        },
                        {
                            "title":"<span class=\"secnum\">5.17 </span> Restrictions on Record Inserts and Updates",
                ...
                },
                {
                    ...
                    "topics":[
                        ...
                        {
                            "title":"<span class=\"secnum\">12.6 </span> Overview of Polymorphic Table Functions",
                            "href":"plsql-optimization-and-tuning.html#GUID-981102A8-5204-4931-B10A-93486304B184",
                            "topics":[
                                {
                                    "title":"<span class=\"secnum\">12.6.1 </span> Polymorphic Table Function Definition",
                                    "href":"plsql-optimization-and-tuning.html#GUID-A496E727-7A54-4F6E-9E8E-82DF7558063E"
                                },
                                {
                                    "title":"<span class=\"secnum\">12.6.2 </span> Polymorphic Table Function Implementation",
                                    "href":"plsql-optimization-and-tuning.html#GUID-C18593DB-7A73-441D-A17D-30F54E25937A"
                                },
                                {
                                    "title":"<span class=\"secnum\">12.6.3 </span> Polymorphic Table Function Invocation",
                                    "href":"plsql-optimization-and-tuning.html#GUID-4847CB51-6939-44C4-9913-CC3CE13B6730",
                                    "topics":[
                                        {
                                            "title":"<span class=\"secnum\">12.6.3.1 </span> Variadic Pseudo-Operators",
                                            "href":"plsql-optimization-and-tuning.html#GUID-A3123AB1-E06D-4E00-A856-6052527482CE"
                                        },
                                        {
                                            "title":"<span class=\"secnum\">12.6.3.2 </span> COLUMNS Pseudo-Operator",
                                            "href":"plsql-optimization-and-tuning.html#GUID-AB520C25-6735-4E5D-AC01-6237CD32BE17"
                                        }
                                    ]
                                },
                                {
                                    "title":"<span class=\"secnum\">12.6.4 </span> Polymorphic Table Function Compilation and Execution",
                                    "href":"plsql-optimization-and-tuning.html#GUID-C0FBB1E4-2D75-4D52-BA85-BCF910AF0DD0"
                                },
                                {
                                    "title":"<span class=\"secnum\">12.6.5 </span> Polymorphic Table Function Optimization",
                                    "href":"plsql-optimization-and-tuning.html#GUID-0999E5D7-EB9B-4DCD-964C-C5F6B278B5DB"
                                },
                                {
                                    "title":"<span class=\"secnum\">12.6.6 </span> Skip_col Polymorphic Table Function Example",
                                    "href":"plsql-optimization-and-tuning.html#GUID-695FBA1A-89EA-45B4-9C81-CA99F6C794A5"
                                },
                                {
                                    "title":"<span class=\"secnum\">12.6.7 </span> To_doc Polymorphic Table Function Example",
                                    "href":"plsql-optimization-and-tuning.html#GUID-F8E13DDD-710D-4626-824E-B344849C5AFE"
                                }
                            ]
                        },
                        {
                            "title":"<span class=\"secnum\">12.7 </span> Updating Large Tables in Parallel",
                            "href":"plsql-optimization-and-tuning.html#GUID-AD1BDE75-DDC1-496E-8964-CA0D41B0C76A"
                        },
                        {
                            "title":"<span class=\"secnum\">12.8 </span> Collecting Data About User-Defined Identifiers",
                            "href":"plsql-optimization-and-tuning.html#GUID-AD358676-E837-45EB-9301-36A094A3BB22"
                        },
                        {
                            "title":"<span class=\"secnum\">12.9 </span> Profiling and Tracing PL/SQL Programs",
                            "href":"plsql-optimization-and-tuning.html#GUID-D99A60B1-E3ED-4252-A85C-8FA732EE9957"
                        },
                        {
                            "title":"<span class=\"secnum\">12.10 </span> Compiling PL/SQL Units for Native Execution",
                            "href":"plsql-optimization-and-tuning.html#GUID-7C4557E7-4C35-4CAB-A95D-CB96BDC6D487",
                            "topics":[
                                {
                                    "title":"<span class=\"secnum\">12.10.1 </span> Determining Whether to Use PL/SQL Native Compilation",
                                    "href":"plsql-optimization-and-tuning.html#GUID-F87C76F7-5044-4A8F-AD73-2A946EFFB31D"
                                },
                                {
                                    "title":"<span class=\"secnum\">12.10.2 </span> How PL/SQL Native Compilation Works",
                                    "href":"plsql-optimization-and-tuning.html#GUID-C01C53DD-0C0C-4D17-B03A-D00CC183A4EF"
                                },
                                {
                                    "title":"<span class=\"secnum\">12.10.3 </span> Dependencies, Invalidation, and Revalidation",
                                    "href":"plsql-optimization-and-tuning.html#GUID-0C95D77E-EA4C-4421-BA1B-7C58027E4C5B"
                                },
                                {
                                    "title":"<span class=\"secnum\">12.10.4 </span> Setting Up a New Database for PL/SQL Native Compilation",
                                    "href":"plsql-optimization-and-tuning.html#GUID-248986EB-62CA-4324-BC51-B20F54392240"
                                },
                                {
                                    "title":"<span class=\"secnum\">12.10.5 </span> Compiling the Entire Database for PL/SQL Native or Interpreted Compilation",
