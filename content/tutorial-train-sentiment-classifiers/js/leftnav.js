...
function amIPartofALearningPath() {
    ...
    $.getJSON(url).done(function(data) {
        ...
        if (data.items.length > 0) {
            ...
            content += "This OBE is associated with the following Learning Paths. Select a Learning Path to view the OBE within that Learning Path or close this dialog to continue outside of a Learning Path.<br/>";
